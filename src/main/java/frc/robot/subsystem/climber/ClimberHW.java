...
public class ClimberHW {
        ...
        public void sense(ClimberInputs inputs) {
                ...
                inputs.outsideClimberVoltageVolts = outsideClimberTalon.getMotorVoltage().getValueAsDouble();
                inputs.outsideClimberCurrentAmps = outsideClimberTalon.getStatorCurrent().getValueAsDouble();
